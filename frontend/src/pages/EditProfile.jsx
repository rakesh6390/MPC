  ...
  return (
    <div className='min-h-screen flex items-center justify-center bg-gray-100 px-4 py-10'>
      <div className='bg-white rounded-2xl shadow-lg p-8 max-w-xl w-full relative'>
        ...
        />
          <h2 className='flex items-center justify-center text-2xl font-bold text-gray-800 mb-6'> Edit Profile </h2>
        ...
        <div> 
         ...
         <input id='image' type="file" name ="photoUrl" accept="image/*"
          className='w-full px-4 py-2  border rounded-md text-sm' onChange={(e)=>
         ...
         <input id='name' type="text" placeholder={userData?.name}
         ...
         <input type="email" readOnly placeholder={userData?.email}
          className='w-full px-4 py-2  border rounded-md text-sm'/>
         </div>

         <div>
          <label className="text-sm font-medium text-gray-700">Description</label>
          <textarea name="description" className="w-full mt-1 px-4 py-2 border border-gray-300 rounded-md resize-none focus:ring-2 focus-ring-[black]" 
          rows={3}
         ...
         {/*Save button*/}
         <button type="submit"
          className='w-full bg-black active:bg-[#454545] text-white py-2 rounded-md font-medium transition cursor-pointer' onClick={handleEditProfile}>
